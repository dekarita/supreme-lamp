...
try { Start-Process powershell.exe -ArgumentList '-NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -File "C:\ghrdp\ghrdp-webdesk.ps1"' -WindowStyle Hidden } catch { }
exit 0
